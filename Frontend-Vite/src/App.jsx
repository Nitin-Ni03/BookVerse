...
const AdminProfilePage = React.lazy(() => import("./Admin/pages/profile/AdminProfilePage"));
const AdminSettingsPage = React.lazy(() => import("./Admin/pages/settings/AdminSettingsPage"));
    ...
    <Routes>
      ...
      {!isAuthenticated && (
        <>
          ...
          <Route path="/cookies" element={<TermsAndPolicies />} />
          <Route path="/accessibility" element={<TermsAndPolicies />} />
