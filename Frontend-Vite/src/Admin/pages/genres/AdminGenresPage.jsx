...
export default function AdminGenresPage() {
  ...
  const handleOpenDialog = (genre = null) => {
    if (genre) {
      ...
      setFormData({
        ...
        parentId: genre.parentId || null, // Ensure strict null if undefined/falsy but not 0 (though IDs are >0)
      });
    } else {
  ...
  const getChildGenres = (parentId) => {
    return (genres || []).filter((g) => g.parentId === parentId);
  };
