...
import { getUsersList, toggleUserActive } from '../../../store/features/auth/authThunk';
...
export default function AdminUsersPage() {
  ...
  const handleToggleActive = async (user) => {
    ...
    if (
      ...
      try {
        await dispatch(toggleUserActive({ userId: user.id })).unwrap();
        // User list is updated automatically via Redux slice
      } catch (error) {
