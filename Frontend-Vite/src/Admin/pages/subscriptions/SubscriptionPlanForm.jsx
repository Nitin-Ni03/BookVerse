...
const SubscriptionPlanForm = ({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setSubmitError(typeof error === 'string' ? error : "Failed to save plan. Please check your inputs.");
    }
  };
  return (
    <Dialog
        ...
        <Grid container spacing={2} sx={{ mt: 0.5 }}>
          <Grid size={{ xs: 12, md: 6 }}>
            <TextField
              ...
              required
              helperText="Unique identifier (uppercase, e.g., BASIC)"
            />
          </Grid>
          <Grid size={{ xs: 12, md: 6 }}>
            <TextField
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <TextField
              ...
              onChange={(e) =>
                setFormData({ ...formData, price: e.target.value === '' ? '' : parseFloat(e.target.value) })
              }
              required
              InputProps={{
                startAdornment: (
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <TextField
              ...
              onChange={(e) =>
                setFormData({
                  ...formData,
                  durationDays: e.target.value === '' ? '' : parseInt(e.target.value),
                })
              }
              required
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <TextField
              ...
              onChange={(e) =>
                setFormData({
                  ...formData,
                  maxBooksAllowed: e.target.value === '' ? '' : parseInt(e.target.value),
                })
              }
              required
              helperText="Maximum books user can borrow"
            />
          </Grid>
          <Grid size={{ xs: 12, md: 6 }}>
            <TextField
              ...
              onChange={(e) =>
                setFormData({
                  ...formData,
                  maxDaysPerBook: e.target.value === '' ? '' : parseInt(e.target.value),
                })
              }
              required
              helperText="Maximum days allowed for each book"
            />
          </Grid>
          <Grid size={{ xs: 12, md: 6 }}>
            <TextField
              ...
              onChange={(e) =>
                setFormData({
                  ...formData,
                  displayOrder: e.target.value === '' ? '' : parseInt(e.target.value),
                })
              }
              helperText="Order for displaying plans"
            />
          </Grid>
          <Grid size={{ xs: 12, md: 6 }}>
            <TextField
              ...
              helperText="Optional badge text"
            />
          </Grid>
          <Grid size={{ xs: 12 }}>
            <TextField
      ...
      <DialogActions sx={{ p: 2 }}>
        ...
        <Button
          ...
          disabled={
            ...
            formData.durationDays === '' || formData.durationDays <= 0 ||
            formData.maxBooksAllowed === '' || formData.maxBooksAllowed <= 0 ||
            formData.maxDaysPerBook === '' || formData.maxDaysPerBook <= 0
          }
          sx={{
