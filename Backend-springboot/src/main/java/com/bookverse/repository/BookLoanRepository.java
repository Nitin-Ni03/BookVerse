 ...
 * Provides CRUD operations and custom query methods for checkout/check-in
 * operations.
 */
@Repository
public interface BookLoanRepository extends JpaRepository<BookLoan, Long> {
       ...
       @Query("SELECT bl FROM BookLoan bl WHERE bl.dueDate < :currentDate " +
                     "AND (bl.status = com.bookverse.domain.BookLoanStatus.CHECKED_OUT OR bl.status = com.bookverse.domain.BookLoanStatus.OVERDUE)")
