...
import com.bookverse.payload.EmailNotificationDTO;
...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendOverdueReminder(String recipient, String userName, String bookTitle,
        ...
        String subject = "âš ï¸ Overdue Book Reminder - Action Required";
    ...
    public void sendDueDateReminder(String recipient, String userName, String bookTitle,
        ...
        String subject = "ðŸ“š Book Due Date Reminder - " + bookTitle;
    ...
    private String buildOverdueReminderHtml(String userName, String bookTitle, String dueDate,
        ...
        return """
            ...
            <body>
                <div class="container">
                    <div class="header">
                        <h2>âš ï¸ Overdue Book Reminder</h2>
                    </div>
                    <div class="content">
                        <p>Dear %s,</p>
    ...
    private String buildDueDateReminderHtml(String userName, String bookTitle, String dueDate, int daysUntilDue) {
        return """
            ...
            <body>
                <div class="container">
                    <div class="header">
                        <h2>ðŸ“š Book Due Date Reminder</h2>
                    </div>
                    <div class="content">
                        <p>Dear %s,</p>
    ...
    public void sendReservationAvailableNotification(String recipient, String userName, String bookTitle,
        ...
        String subject = "ðŸŽ‰ Your Reserved Book is Now Available - " + bookTitle;
    ...
    private String buildReservationAvailableHtml(String userName, String bookTitle,
        ...
        return """
            ...
            <body>
                <div class="container">
                    <div class="header">
                        <h2>ðŸŽ‰ Your Reserved Book is Available!</h2>
                    </div>
                    <div class="content">
                        <p>Dear %s,</p>
                        ...
                        <div class="warning">
                            <p><strong>â° Important:</strong> Please pick up this book within <strong>%d hours</strong>.</p>
