...
import com.bookverse.domain.BookLoanType;
import com.bookverse.exception.BookException;
import com.bookverse.exception.BookLoanException;
import com.bookverse.exception.SubscriptionException;
import com.bookverse.exception.UserException;
import com.bookverse.mapper.BookLoanMapper;
import com.bookverse.modal.Book;
import com.bookverse.modal.BookLoan;
import com.bookverse.modal.User;
import com.bookverse.payload.CheckoutStatistics;
import com.bookverse.payload.dto.BookLoanDTO;
import com.bookverse.payload.dto.SubscriptionDTO;
import com.bookverse.payload.request.BookLoanSearchRequest;
import com.bookverse.payload.request.CheckinRequest;
import com.bookverse.payload.request.CheckoutRequest;
import com.bookverse.payload.request.RenewalRequest;
import com.bookverse.payload.response.PageResponse;
import com.bookverse.repository.BookLoanRepository;
import com.bookverse.repository.BookRepository;
import com.bookverse.repository.UserRepository;
import com.bookverse.service.BookLoanService;
import com.bookverse.service.FineCalculationService;
import com.bookverse.service.ReservationService;
import com.bookverse.service.SubscriptionService;
...
public class BookLoanServiceImpl implements BookLoanService {
    ...
    public BookLoanDTO checkoutBookForUser(Long userId,
        ...
        try {
            ...
            throw new BookLoanException(
                    "No active subscription found. Please subscribe to a plan to checkout books.", e);
        }
    ...
    public PageResponse<BookLoanDTO> getBookLoans(BookLoanSearchRequest searchRequest) {
        ...
        // 1ï¸âƒ£ Build pageable with sorting, size, etc.
        ...
        // 2ï¸âƒ£ Apply filtering logic dynamically
        ...
        // 3ï¸âƒ£ Convert entities to DTOs and wrap in response object
        return convertToPageResponse(bookLoanPage);
    }
    ...
    @Override
    public BookLoanDTO updateBookLoan(Long bookLoanId, com.bookverse.payload.request.UpdateBookLoanRequest updateRequest)
