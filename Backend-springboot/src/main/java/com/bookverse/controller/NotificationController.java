...
import com.bookverse.payload.request.PushTokenRequest;
import com.bookverse.payload.response.ApiResponse;
import com.bookverse.service.NotificationService;
import com.bookverse.service.PushTokenService;
 ...
 *
 * Endpoints:
 * - GET    /api/notifications          â†’ List user notifications (paged)
 * - GET    /api/notifications/unread   â†’ List unread notifications
 ...
 * - DELETE /api/notifications/all       â†’ Delete all notifications
 * - POST   /api/notifications/push-token â†’ Register push notification token
 * - DELETE /api/notifications/push-token â†’ Delete push notification token
 */
@RestController
