...
public class BookLoanController {
     ...
     * POST /api/book-loans/search
     */
    @PostMapping("/search")   // âœ… FIXED
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<?> getAllBookLoans(
            @Valid @RequestBody BookLoanSearchRequest searchRequest) {
    ...
    public ResponseEntity<?> updateBookLoan(
            ...
            @Valid @RequestBody com.bookverse.payload.request.UpdateBookLoanRequest updateRequest) {
        try {
     ...
     */
    @PutMapping("/admin/update-overdue")
    @PreAuthorize("hasRole('ADMIN')")
