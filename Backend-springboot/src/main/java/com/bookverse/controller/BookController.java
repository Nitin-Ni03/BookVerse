...
public class BookController {
     ...
     * - GET /api/books?genreId=1                          â†’ Books by genre ID 1
     * - GET /api/books?availableOnly=true                 â†’ Available books
     * - GET /api/books?genreId=1&availableOnly=true       â†’ Available books by genre ID 1
     */
    @GetMapping
