 ...
 * Supports full CRUD operations with validation and automatic timestamp
 * management.
 */
@Entity
...
public class Book {
    ...
    @Pattern(regexp = "^[0-9-]{10,17}$", message = "ISBN format is invalid (must be 10-17 characters, digits and dashes only)")
